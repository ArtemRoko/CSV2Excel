...
if __name__ == '__main__':
    ...
    template_file = './template/CGV_enrichment_template_v5.0.xlsx'  # Should be in xlsx format
    ...
    skip_existing = True  # skip processing if an output file already addexists
